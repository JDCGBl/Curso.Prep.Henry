...
function esPrimo(numero) {
  ...
  for (var i = 2; i < numero; i++){
       //se indica de donde  //Mientras numeroRa sea    //se indica que se suma
       //se inicia           //menor o igual a numero//de 1 en 1
                             //se va a parar hasta que 
                             //sea false 
    if (numero % i === 0){
      return false;
    }
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí  let arrayTablaDel6 = []
